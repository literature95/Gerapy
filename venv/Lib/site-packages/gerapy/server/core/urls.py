...
urlpatterns = [
    ...
    url(r'^api/visualization/$', views.visualization, name='visualization'),
    url(r'^api/visualization_data/$', views.visualization_data, name='visualization_data'),  # 确保URL模式正确
    ...
    url(r'^api/data$', views.data_list, name='data_list'),
    url(r'^api/data/(\d+)$', views.data_detail, name='data_detail'),
]
